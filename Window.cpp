...
Slots::Slots(Shaders &shaders)
{
	...
	tranformMatrix = shaders.findUniform("transforms", Slots::shadersProgram);
	viewMatrix = shaders.findUniform("view", Slots::shadersProgram);
	perspectiveMatrix = shaders.findUniform("perspective", Slots::shadersProgram);
	textureSlot = shaders.findUniform("basicTexture", Slots::shadersProgram);
	colour = shaders.findUniform("colour", Slots::shadersProgram);
}
